...
public abstract class CESharedZLevelGhostMoverSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StationAiHeldComponent, CEZLevelActionUp>(OnHeldAiZLevelUp);
        SubscribeLocalEvent<StationAiHeldComponent, CEZLevelActionDown>(OnHeldAiZLevelDown);
    }
