...
Space Onyx - это основывающийся форк на Corvax Goob который активно модифицируемый и является форком всем изестного репозитория Goob Station, направленный на его перевод и создание собственного контента.

## Ссылки

[Наш Discord](https://discord.station14.ru) | [Наша Вики](https://wiki.station14.ru) | [Steam](https://store.steampowered.com/app/1255460/Space_Station_14/) | [Клиент без Steam](https://spacestation14.io/about/nightlies/) | [Основной репозиторий](https://github.com/space-wizards/space-station-14) | [Основной репозиторий Goob Station](https://github.com/Goob-Station/Goob-Station) [Основной репозиторий CorvaxGoob](https://github.com/space-syndicate/Goob-Station)
