...
# Augment Examine
augment-examine-header = [bold]Augmentations:[/bold]
augment-examine-entry = [color={$color}]  {$part}:[/color] {$text}
augment-examine-runner = Runner implant (+4% speed)
augment-examine-runner-advanced = Advanced Runner implant (+8% speed)
augment-examine-unknown-part = unknown
