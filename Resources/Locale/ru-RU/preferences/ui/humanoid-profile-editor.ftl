...
humanoid-profile-editor-weight-label = Ширина:
humanoid-profile-editor-reset-weight-button = Сброс
humanoid-profile-editor-calculated-weight-default-label = Вес: 0кг
humanoid-profile-editor-calculated-weight-label = Вес: { $weight }кг
