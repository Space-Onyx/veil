...
upgradeable-gun-slot-name = Слот модификации {$value}
upgradeable-gun-total-remaining-capacity = Оставшаяся общая вместимость: {$value}
gun-upgrade-capacity-cost = Требуется {$value} вместимости.

gun-upgrade-inserted-examine-type-contains = Содержит улучшение «{$name}».
gun-upgrade-inserted-examine-type-attached = Имеет прикреплённое сбоку улучшение «{$name}».
...
gun-upgrade-crusher-lava-aspect = Клинок с аспектом [bold]лавы[/bold]
gun-upgrade-crusher-ice-frost = Клинок с аспектом [bold]льда[/bold]
gun-upgrade-crusher-sharpness = Клинок с эффектом [bold]остроты[/bold]

gun-upgrade-crusher-weights = [bold]утяжелённая[/bold] рукоять
gun-upgrade-crusher-lightweight = [bold]облегчённая[/bold] рукоять
gun-upgrade-crusher-range = [bold]удлинённая[/bold] рукоять
