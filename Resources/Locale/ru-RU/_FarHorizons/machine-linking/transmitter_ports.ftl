...
signal-port-description-nuclear-reactor-data-sender = Отправляет информацию о ядерном реакторе на монитор.
...
signal-port-description-gas-turbine-data-sender = Отправляет информацию о газовой турбине на монитор.
