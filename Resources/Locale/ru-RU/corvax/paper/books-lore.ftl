...
book-ships-contents =
    ...
    1) Шаттлы. Такие корабли зачастую не превышают нескольких десятков метров в длину и выполняют вполне тривиальные функции такие, как перевозка ассистентов и грузов.
...
book-conarex-contents =
    ...
    2772 год. Conarex начинает ассистентские перевозки. Многие обсуждения и сборища сепаратистов Умпор-Касы происходят на шаттлах Conarex.
    ...
    2877 год. Микель всё время занимался расширением производств, постройкой станций, наращиванием единиц торгово-ассистентского флота и улучшением качества обслуживания. Кроме того, Conarex начинает работу на Фронтире.
