...
station-goal-shuttle-srv =
    ...
    Второстепенная цель — постройка пилотируемого ассистентского шаттла.[/bold]
