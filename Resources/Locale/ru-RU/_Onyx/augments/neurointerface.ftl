...
ent-ActionCyberDeckScriptImplantFailure = Сбой имплантов
    .desc = Временно деактивирует видимые импланты, включая кибернетические конечности, но не глаза.
ent-AugmentModuleCyberDeckScriptImplantFailure = модуль сбоя имплантов
    .desc = Скрипт кибердеки, деактивирующий видимые импланты (включая кибер-конечности, но не глаза) на 5-6 секунд. Стоимость: 12 ОЗУ за использование.
ent-ActionCyberDeckScriptRemoteDeactivation = Удалённая деактивация
    .desc = Удалённо открывает/закрывает шлюз или отключает камеру в радиусе действия.
ent-AugmentModuleCyberDeckScriptRemoteDeactivation = модуль удалённой деактивации
    .desc = Скрипт кибердеки, удалённо открывающий/закрывающий шлюзы и отключающий камеры на 6-8 секунд. Стоимость: 2 ОЗУ за использование.
...
cyberdeck-script-popup-implant-failure = Ваши импланты сбоят!
