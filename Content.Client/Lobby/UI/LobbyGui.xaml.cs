...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class LobbyGui : UIScreen
    {
        ...
        public LobbyGui()
        {
            ...
            UpdateDiscordButtonState(); // </Onyx-DiscordAuth>
        }
        ...
        protected override void FrameUpdate(FrameEventArgs args)
        {
            ...
            // <Onyx-DiscordAuth>
            var discordAuthEnabled = _cfg.GetCVar(CCVars.DiscordAuthEnable);
            var requiresDiscordRefresh = (discordAuthEnabled && ShouldShowDiscordButton()) ||
                                         (discordAuthEnabled && _cfg.GetCVar(CCVars.DiscordAuthLinkRequired));
        ...
        {
            return _cfg.GetCVar(CCVars.DiscordAuthEnable) &&
                   _cfg.GetCVar(CCVars.ExtraLobbyPanelEnabled);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                _discordIdManager.DiscordInfoUpdated -= OnDiscordInfoUpdated; // <Onyx-DiscordAuth>
            }
