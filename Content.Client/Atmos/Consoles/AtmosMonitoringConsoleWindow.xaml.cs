...
public sealed partial class AtmosMonitoringConsoleWindow : FancyWindow
{
    ...
    public AtmosMonitoringConsoleWindow(AtmosMonitoringConsoleBoundUserInterface userInterface, EntityUid? owner)
    {
        ...
        if (_entManager.TryGetComponent<TransformComponent>(owner, out var xform))
        {
            ...
            if (_monitorMapUid != null &&
                _entManager.TryGetComponent<MetaDataComponent>(_monitorMapUid.Value, out var stationMetaData))
        ...
        // Initalize
        UpdateUI(consoleCoords, Array.Empty<AtmosMonitoringConsoleEntry>(), new List<int> { 0 }, 0, 0, null);
    }
        ...
        NetEntity? selectedFloorMap)
    {
        ...
        if (consoleCoords != null && consoleNetEnt != null && NavMap.MapUid == _monitorMapUid)
        {
