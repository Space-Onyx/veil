...
public sealed partial class PowerMonitoringWindow : FancyWindow
{
        ...
        EntityCoordinates? monitorCoords)
    {
        ...
        if (_focusEntity != null && !console.PowerMonitoringDeviceMetaData.ContainsKey(_focusEntity.Value))
            _focusEntity = null;
        ...
        if (monitorCoords != null && mon.IsValid() && NavMap.MapUid == _monitorMapUid)
        {
