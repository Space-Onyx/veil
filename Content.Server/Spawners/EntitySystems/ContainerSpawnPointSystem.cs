...
using Content.Server._Onyx.Station.Components; // Onyx-ForceCryoSpawn
...
public sealed class ContainerSpawnPointSystem : EntitySystem
{
    ...
    public void HandlePlayerSpawning(PlayerSpawningEvent args)
    {
        ...
        if (!forceCryo && args.HumanoidCharacterProfile?.SpawnPriority != SpawnPriorityPreference.Cryosleep &&
            (!_proto.TryIndex(args.Job, out var jobProto) || jobProto.JobEntity == null)) // Onyx-ForceCryoSpawn edited
        {
            return;
        }
