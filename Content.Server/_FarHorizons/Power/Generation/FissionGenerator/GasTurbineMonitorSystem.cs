...
public sealed partial class GasTurbineMonitorSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GasTurbineMonitorComponent, BoundUIOpenedEvent>(OnBoundUiOpened);
    ...
    private void OnBoundUiOpened(EntityUid uid, GasTurbineMonitorComponent comp, ref BoundUIOpenedEvent args)
    {
