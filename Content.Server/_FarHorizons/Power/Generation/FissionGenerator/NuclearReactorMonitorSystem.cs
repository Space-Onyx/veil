...
public sealed partial class NuclearReactorMonitorSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<NuclearReactorMonitorComponent, BoundUIOpenedEvent>(OnBoundUiOpened);
    ...
    private void OnBoundUiOpened(EntityUid uid, NuclearReactorMonitorComponent comp, ref BoundUIOpenedEvent args)
    {
