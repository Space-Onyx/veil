...
public sealed partial class TurbineSystem : SharedTurbineSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<TurbineComponent, BoundUIOpenedEvent>(OnBoundUiOpened);
    ...
    #region BUI
    private void OnBoundUiOpened(EntityUid uid, TurbineComponent turbine, ref BoundUIOpenedEvent args)
    {
