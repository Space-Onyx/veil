...
public sealed partial class NuclearReactorSystem : SharedNuclearReactorSystem
{
    ...
    public override void Initialize()
    {
        ...
        // BUI events
        SubscribeLocalEvent<NuclearReactorComponent, BoundUIOpenedEvent>(OnBoundUiOpened);
    ...
    #region BUI
    private void OnBoundUiOpened(Entity<NuclearReactorComponent> ent, ref BoundUIOpenedEvent args)
    {
    ...
    private void OnItemActionMessage(Entity<NuclearReactorComponent> ent, ref ReactorItemActionMessage args)
    {
        ...
        if (comp.PartSlot.Item == null)
        {
            ...
            comp.TemperatureGrid[(int)pos.X, (int)pos.Y] = 0;
            comp.NeutronGrid[(int)pos.X, (int)pos.Y] = 0;
            comp.FluxGrid[(int)pos.X, (int)pos.Y].Clear();
        }
        else
        {
            ...
            comp.TemperatureGrid[(int)pos.X, (int)pos.Y] = comp.ComponentGrid[(int)pos.X, (int)pos.Y]!.Temperature;
            comp.NeutronGrid[(int)pos.X, (int)pos.Y] = comp.FluxGrid[(int)pos.X, (int)pos.Y].Count;
